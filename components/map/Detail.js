...
function Detail() {
    return (
        <>
            <section className="w-full sm:w-[420px] fixed bottom-0 left-0 transition-all z-[1] bg-white h-[360px] sm:h-[calc(100vh-80px)] overflow-x-clip overflow-y-auto drop-shadow-lg">
                ...
                <div>
                    <div className="flex flex-col items-center py-6 border-b border-[#ededed] mx-5">
                        <h3 className="text-[22px] text-black font-bold">딩가케이크</h3>
